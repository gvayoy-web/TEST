...
const REWARD_DEFINITIONS = [
    { code: 'BESO', icon: SVGS.heart, label: 'vale especial', title: 'Beso', desc: 'Canjéalo para darte un gran beso, válido para siempre.', rarity: 'epico', page: 'letter-epic.html' },
    { code: 'CITA', icon: SVGS.sparkles, label: 'vale especial', title: 'Cita sorpresa', desc: 'Cita especial organizada 100% por mí.', rarity: 'epico', page: 'letter-epic.html' },
    { code: 'ABRAZO', icon: SVGS.heart2, label: 'vale emocional', title: 'Abrazo', desc: 'Un abrazo cálido y sincero que te calienta el alma. Válido por tiempo infinito.', rarity: 'epico', page: 'letter-epic.html' },
    { code: 'LUCYDAVID', icon: SVGS.sparkles, label: 'vale personal', title: 'Lucy David', desc: 'Un momento solo para ti y tu persona especial.', rarity: 'epico', page: 'letter-epic.html' },
    ...
    { code: 'SONRISA', icon: SVGS.smile, label: 'vale feliz', title: 'Sonrisa Garantizada', desc: 'Un día entero dedicado a hacerte sonreír. Sin motivos, solo por alegrarte.', rarity: 'epico', page: 'letter-epic.html' },
    ...
    { code: 'KARAOKE', icon: SVGS.mic, label: 'vale musical', title: 'Karaoke Night', desc: 'Noche de karaoke con tus canciones favoritas. Tú cantas, yo te aplaudo.', rarity: 'especial', page: 'movienigth1.html' },
    ...
    { code: 'NOVIO', icon: SVGS.heart, label: 'vale de relación', title: 'Novio Oficial', desc: 'Ya no hay vuelta atrás. Eres mi persona, oficialmente.', rarity: 'mitico', page: 'letter-epic.html' },
    ...
    { code: 'EKKOJINX', icon: SVGS.sparkles, label: 'vale geek', title: 'Ekko x Jinx', desc: 'El combo perfecto. Caos y protección en una sola pareja.', rarity: 'legendario', page: 'date-legendary.html', theme: 'brawl' },
...
const LETTERS_BY_CODE = {
    BESO: {
        chapters: [
            { label: 'capítulo uno', text: 'Hay besos que se dan por costumbre y besos que se dan porque no hay otra forma de decir lo que sientes. Los tuyos son de esos.' },
            { label: 'capítulo dos', text: 'Desde el primer beso entendí que contigo las cosas son diferentes: el tiempo se detiene un segundo, la música de fondo se sube sola y todo lo demás desaparece.' },
            { label: 'capítulo tres', text: 'Este vale no tiene caducidad, no necesita firma y se puede canjear en cualquier lugar del mundo: en un parque, en el cine, en la cocina de tu casa o un martes cualquiera.' }
        ],
        final: 'preséntalo y cierra los ojos'
    },
    CITA: {
        chapters: [
            { label: 'capítulo uno', text: 'Una cita sorpresa es una forma de decir "pensé en ti aunque no me lo pediste". Y pensar en ti es, literalmente, mi hobby favorito.' },
            { label: 'capítulo dos', text: 'No te diré el lugar, ni la hora, ni el plan completo. Solo te diré que empieces el día con ropa cómoda y ganas de reír.' },
            { label: 'capítulo tres', text: 'Yo me encargo de todo lo demás: la reserva, los detalles, la música y de mirarte cuando no te das cuenta.' }
        ],
        final: 'este vale vale por una sorpresa real'
    },
    ABRAZO: {
        chapters: [
            { label: 'capítulo uno', text: 'Hay días que pesan y días que no. Este vale existe para los días que pesan: un abrazo largo, de esos que arreglan más de lo que deberían.' },
            { label: 'capítulo dos', text: 'Duración mínima de canje: tres minutos. Prohibido soltarse antes de que se acabe la canción que esté sonando.' },
            { label: 'capítulo tres', text: 'Válido para después de un partido, para un día feo, para una noticia buena o simplemente porque sí.' }
        ],
        final: 'válido por tiempo infinito'
    },
    LUCYDAVID: {
        chapters: [
            { label: 'capítulo uno', text: 'Hay historias que empiezan como cualquier otra y terminan siendo la única que importa. La nuestra es así.' },
            { label: 'capítulo dos', text: 'Tú y yo tenemos esa dinámica de las parejas que se conocen de verdad: reírnos de lo mismo, entendernos sin hablar y defender el uno al otro sin dudar.' },
            { label: 'capítulo tres', text: 'Este vale es un recordatorio: pase lo que pase, siempre hay un momento que es solo tuyo y mío.' }
        ],
        final: 'siempre nosotros dos'
    },
    CARTA: {
        chapters: [
    ...
    SONRISA: {
        chapters: [
            { label: 'capítulo uno', text: 'Una sonrisa garantizada no es un premio pequeño. Es el único del que no se cansa nadie, y el tuyo es de los mejores.' },
            { label: 'capítulo dos', text: 'El plan es simple: un día entero para hacerte reír. Chistes malos, anécdotas, videos raros y todo lo que se necesite.' },
            { label: 'capítulo tres', text: 'Y si al final del día no logro sacarte ni media sonrisa, te prometo un helado y otro intento mañana.' }
        ],
        final: 'sonríe, que se te da increíble'
    },
    NOVIO: {
        chapters: [
            { label: 'capítulo uno', text: 'Esto no es un premio. Es una declaración oficial, sellada y sin vuelta atrás: eres mi persona.' },
            { label: 'capítulo dos', text: 'Me gustas completa: tu voz, tus ocurrencias, tu forma de jugar, tu forma de querer. No cambiaría ni un capítulo de nosotros.' },
            { label: 'capítulo tres', text: 'Este vale caduca... nunca. Válido por toda la historia que nos falta por escribir.' }
        ],
        final: 'oficialmente, para siempre'
    }
};
